...
const Card = ({
  ...
  return (
    <div
      className={`px-mobile md:px-tablet lg:px-desktop py-desktop relative ${className} overflow-hidden flex flex-col md:flex-row gap-50 bg-white justify-end items-center lg:items-end`}
    >
      <div
